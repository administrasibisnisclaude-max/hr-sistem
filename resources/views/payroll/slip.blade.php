...
<div class="page-header">
    <h1 class="page-title"><i class="fas fa-file-alt me-2 text-primary"></i>Slip Gaji</h1>
...
<div class="card" style="max-width:700px; margin:0 auto;" id="slipContent">
    <div class="card-body p-4">
        ...
        <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-4">
            <div class="d-flex align-items-center">
                ...
                @else
                    <div style="width:50px;height:50px;background:#3b5998;border-radius:10px;display:flex;align-items:center;justify-content:center;margin-right:15px;">
        ...
        <div class="row g-3 mb-4 p-3 bg-light rounded">
            ...
            <div class="col-6">
                ...
                <strong>{{ $payroll->employee->nik }}</strong>
            </div>
            <div class="col-6">
                <small class="text-muted d-block">Jabatan</small>
                <strong>{{ $payroll->employee->position?->name ?? '-' }}</strong>
            </div>
            <div class="col-6">
