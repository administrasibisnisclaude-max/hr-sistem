...
<div class="page-header">
    <h1 class="page-title"><i class="fas fa-file-contract me-2 text-primary"></i>Tambah Kontrak</h1>
        ...
        <form action="{{ route('contracts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <small class="text-muted">Kosongkan untuk karyawan tetap</small>
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-4">
                <label class="form-label fw-semibold">File Kontrak (PDF)</label>
